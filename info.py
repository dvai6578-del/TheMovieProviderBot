...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "dvai6578_db_user")
DATABASE_NAME = environ.get('DATABASE_NAME', "mongodb+srv://dvai6578_db_user:08bocKC8HU5fjTaS@shrabon.vttiowl.mongodb.net/?retryWrites=true&w=majority&appName=shrabon")
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/ShrabonHindiMovies')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+aKXnjdF-WbFhOWU1')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002944667934')) #Log channel id ( make sure bot is admin )
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/SharbonsFilms') #Support group link ( make sure bot is admin )
